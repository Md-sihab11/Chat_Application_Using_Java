...
class CustomThemePanelOne extends JPanel {
    private Image bg;
    public CustomThemePanelOne(String path) {
        try {
...
public class UserOne implements ActionListener, Runnable {
    ...
    JTextField text;
    CustomThemePanelOne mainChatPanel;
    static Box vertical = Box.createVerticalBox();
    static JFrame f = new JFrame("Chat ONN - Akash");
    ...
    UserOne() {
        ...
        // 3 Other Online Friends
        addFriendToSidebar(sidebar, "icons/mirzapur.png", "Shohag", 255);
        addFriendToSidebar(sidebar, "icons/mirzapur.png", "Arafat", 315);
        ...
        // --- 2. MAIN CHAT AREA ---
        mainChatPanel = new CustomThemePanelOne("icons/Theme1.jpg");
