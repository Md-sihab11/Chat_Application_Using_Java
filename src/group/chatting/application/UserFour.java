...
public class UserFour implements ActionListener, Runnable {
    ...
    static JFrame f = new JFrame("Chat ONN- arafat");

    BufferedReader reader;
    BufferedWriter writer;
    String name2 = "DIU Community";
    String name = "Arafat";
    JScrollPane sp;
    ...
    UserFour() {
        ...
        // Friend 3: Arafat
        addFriendToSidebar(sidebar, "icons/mirzapur.png", "Arafat", 375);
        // Friend 3: Arafat
        addFriendToSidebar(sidebar, "icons/mirzapur.png", "Shakib", 435);

        // Active Group selection
        JLabel activeChat = new JLabel("  DIU_COMBINE_STUDY Chat");
        activeChat.setBounds(15, 500, 270, 50);
        ...
        // The 3 Icons (Plus, Camera, Gallery)
